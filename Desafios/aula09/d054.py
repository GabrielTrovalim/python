...
for c in range(0,7):
    cont += 1
    age = int(input('Em que ano a {}° pessoa nasceu? '.format(cont)))
    lista.append(age)
...
age06 = hoje - lista[5]
age07 = hoje - lista[6]
lista18 = [] # para os maiores de 18
lista17 = [] # para os menores de 18
...
print('\nEm relação a data atual temos {} pessoas maiores de idade e {} pessoas manores de idade.'.format(len(lista18), len(lista17)))